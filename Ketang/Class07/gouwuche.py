...
while True:
    ...
    if choice.isdigit():
        ...
        if choice > 0 and choice <= len(product_list):
            ...
            if saved_money >= product_list[choice-1][1]:
                ...
                # choice_goods_car_cf1 = choice_goods_car_cf.update({k: v})#错误的
 ...
 # 添加到购物车
                # for j in choice_goods_car:
                #     if j not in choice_goods_car:
                #         choice_goods_car_cf.append(j)
                #         print(choice_goods_car,'ddddd')
                #
                #     else:
                #         pass
                #         # choice_goods_car_cf.append()
                #         # print('多余的商品：',choice_goods_car_cf)
